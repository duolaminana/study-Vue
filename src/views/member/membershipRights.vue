  ...
  <div class="app-container roleManagement">
    <div class="search-box">
      <el-form label-width="90px" inline size="small">
        ...
        <el-form-item :label="$t('system.role.status')">
          <el-select v-model="postData.rightStatus" :placeholder="$t('system.role.all')" clearable style="width: 200px">
            <el-option
    ...
    >
      <el-form :model="ruleForm" status-icon ref="ruleForm" label-width="100px" class="demo-ruleForm">
        <el-form-item :label="$t('member.rights.interests')" prop="rightName">
          <el-input v-model="ruleForm.rightName" style="width:300px"></el-input>
        </el-form-item>
        <el-form-item :label="$t('member.rights.description')" prop="rightDescription">
          <el-input
            type="textarea"
            placeholder="500字内"
            maxlength="500"
            show-word-limit
            style="width:300px"
            v-model="ruleForm.rightDescription"
          >
          </el-input>
        </el-form-item>
      </el-form>
