  ...
  <div class="app-container goutong-test">
    ...
    <el-dialog :visible.sync="dialogVisible" :title="dialogType==='add'?'客户沟通记录新增': '客户沟通记录编辑'" center width="950px" @closed="clearData">
      <el-form ref="addCompany" :model="adsPosition" label-width="100px" label-position="right" size="small" inline :rules="adsPositionRules">
        <el-form-item label="客户名称" prop="customerBId">
          <el-select v-model="adsPosition.customerBId" clearable style="width: 330px">
    ...
    <el-dialog :visible.sync="detailModal" title="客户沟通记录详情" center width="1000px" @closed="clearData">
      ...
      <el-table
        ...
        <el-table-column align="center" label="沟通日期" prop="createTime" show-overflow-tooltip>
          <template slot-scope="scope">
    ...
    <!--详情-->
    <el-dialog :visible.sync="dialogVisibleDetail" title="客户沟通记录详情" center width="950px" @closed="clearData">
      <el-form ref="addCompany" :model="adsPosition" label-width="100px" label-position="right" size="small" inline :rules="adsPositionRules">
        <el-form-item label="客户名称" prop="customerBId">
...
export default {
  ...
  methods: {
    ...
    openDetail(row) {
      ...
      this.filesList = row.filesList;
      this.customerNameNum = row.customerName;
