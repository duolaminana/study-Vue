  ...
  <div class="app-container editOrder">
    ...
    <el-form ref="editForm" :model="editForm" label-width="120px" size="small" class="edit-form">
      ...
      <el-row>
        ...
        <el-col :span="12">
          <el-form-item label="出发港口/地址" prop="departurePort">
            <el-input v-model="editForm.departurePort" readonly placeholder="出发港口" class="form-dialog-width" />
          </el-form-item>
        </el-col>
        <el-col :span="12">
          <el-form-item label="目的港口/地址" prop="arrivePort">
            <el-input v-model="editForm.arrivePort" readonly placeholder="目的港口" class="form-dialog-width" />
          </el-form-item>
        </el-col>
        <el-col :span="12">
        ...
        <el-col :span="12">
          <el-form-item label="付款方式" prop="payMode">
            <el-select v-model="editForm.payMode" disabled placeholder="请选择付款方式" class="form-dialog-width">
      ...
      <el-form-item style="text-align: center">
        <el-button type="primary" size="small" v-if="Number($route.query.type) === 4" :loading="loading2" @click="checkOrder(5)">确认</el-button>
        <el-button type="primary" size="small" v-if="Number($route.query.type) === 4" :loading="loading2" @click="checkOrder(0)">作废</el-button>
