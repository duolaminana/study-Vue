  ...
  <div class="app-container editOrder">
    ...
    <el-form ref="editForm" :model="editForm" :rules="editFormRules" label-width="120px" size="small" class="edit-form">
      ...
      <el-table
        ...
        <el-table-column align="center" width="120" label="报价量" prop="quotedQuantity">
          <template slot-scope="scope">
            <el-input v-model="scope.row.productQuantity" @blur="changerAmount(scope.row)" />
          </template>
        </el-table-column>

        <el-table-column align="center" width="120" label="报价单价" prop="quotedPrice">
          <template slot-scope="scope">
            <el-input v-model="scope.row.productPrice" @blur="changerAmount(scope.row)"/>
          </template>
        </el-table-column>

        <el-table-column align="center" width="100" label="报价金额" prop="productAmount" show-overflow-tooltip/>

        <el-table-column align="center" min-width="150" label="报价备注" prop="quotedRemark">
          <template slot-scope="scope">
      ...
      <el-row style="margin-top: 16px">
        ...
        <el-col :span="8">
          <el-form-item label="报价单总额" v-if="editForm.quotedNo">
            ...
            {{(allAmount - editForm.orderFreight) | moneyFmt}}
          </el-form-item>
        </el-col>
        <el-col :span="8">
    ...
    <el-dialog :visible.sync="dialogVisible" title="选择订单商品" width="900px" center close-on-click-modal>
      <el-form label-width="100px" label-position="right" inline size="small">
        <el-form-item label="商品编码" prop="productCode">
          <el-input v-model="searchObj.productCode" clearable placeholder="product code" style="width: 240px"/>
        </el-form-item>
        <el-form-item label="商品名称" prop="productName">
          <el-input v-model="searchObj.productName" clearable placeholder="product name" style="width: 240px"/>
        </el-form-item>
          <el-form-item label="sku名称" prop="attrValueList">
            <el-input v-model="searchObj.attrValueList" clearable placeholder="sku name" style="width: 240px"/>
          </el-form-item>
        <el-form-item>
  ...
  methods: {
    ...
    getQuoteDetail() {
      detailQuotedPrice({ quotedPriceBId: this.$route.query.quoteId }).then(res => {
        ...
        this.editForm.customerBId = res.data.buyerBId;
        ...
        this.editForm.payMode = Number(res.data.paymentCondition);
