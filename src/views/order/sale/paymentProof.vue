<template>
  <div class="app-container saleOrderPay">
    ...
    <el-table
      ...
      <el-table-column label="订单货币" prop="orderCurrency" show-overflow-tooltip/>

      <el-table-column align="center" label="订单总金额" prop="totalAmount" show-overflow-tooltip>
    ...
    <el-dialog :visible.sync="dialogVisible" title="销售订单收款记录" width="1100px" center :close-on-click-modal="false">
      <el-form ref="detailForm" :model="detailForm" label-width="140px" size="small">
        ...
        <el-row class="row-item">
          <el-col>
            <div style="font-weight: bold;line-height: 1.5rem">收款记录表：</div>
            <el-table
              :data="recRecordList"
              border
              fit
